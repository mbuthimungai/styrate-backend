...
class CRUDBase(Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
    ...
    async def get_multi(self, db: AsyncSession) -> ModelType:
    ...
    # partially remove an entity by setting the is_deleted flag to True
    # model must contain an is_deleted. e.g. where(self.model.is_deleted == False)
    async def soft_remove(self, db: AsyncSession, *, obj_id: str) -> Optional[ModelType]:
